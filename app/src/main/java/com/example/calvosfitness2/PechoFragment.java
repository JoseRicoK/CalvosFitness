...
public class PechoFragment extends Fragment {
    ...
    private ImageView imageViewPecho;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pecho, container, false);

        imageViewPecho = view.findViewById(R.id.imageViewPecho);
