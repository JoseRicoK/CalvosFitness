...
public class Pecho2Fragment extends Fragment {

    private ImageView imageViewPecho2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pecho2, container, false);

        imageViewPecho2 = view.findViewById(R.id.imageViewPecho2);
